...
{ 
    ...
    t.remove(30); 
    cout << "Traversal of tree after removing 30\n"; 
    t.traverse(); 
    cout << endl; 
  
    t.remove(54); 
    cout << "Traversal of tree after removing 54\n"; 
    t.traverse(); 
    cout << endl; 
  
    t.remove(70); 
    cout << "Traversal of tree after removing 70\n"; 
    t.traverse(); 
    cout << endl; 
  
    t.remove(25); 
    cout << "Traversal of tree after removing 25\n"; 
    t.traverse(); 
    cout << endl; 
